                                ...
                                <div key={index} className="col-lg-4 col-md-6 pe-2 ps-2">
                                    <div className="card p-3 bg-white w-100 hover-card border-0 shadow-xss rounded-xxl border-0 mb-3 overflow-hidden">
                                        <div className="card-image w-100">
                                            <a href="/defaultevent" title={t('event.actions.viewDetails')}>
                                        ...
                                        <div className="card-body d-flex ps-0 pe-0 pb-0">
                                            ...
                                            <h2 className="fw-700 lh-3 font-xss">
                                                ...
                                                <span className="d-flex font-xssss fw-500 mt-2 lh-3 text-grey-500">
                                                    ...
                                                    {t('event.location.prefix')} {value.location}
                                                </span>
                                            </h2>
                                        </div>
                                        <div className="card-body p-0">
                                            <ul className="memberlist mt-4 mb-2 ms-0 d-inline-block">
                                                <li><a href="/defaultevent" title={t('event.actions.viewMembers')}><img src="assets/images/user.png" alt="member" className="w30 d-inline-block" /></a></li>
                                                <li><a href="/defaultevent" title={t('event.actions.viewMembers')}><img src="assets/images/user.png" alt="member" className="w30 d-inline-block" /></a></li>
                                                <li><a href="/defaultevent" title={t('event.actions.viewMembers')}><img src="assets/images/user.png" alt="member" className="w30 d-inline-block" /></a></li>
                                                <li><a href="/defaultevent" title={t('event.actions.viewMembers')}><img src="assets/images/user.png" alt="member" className="w30 d-inline-block" /></a></li>
                                                <li className="last-member">
                                                    <a href="/defaultevent" className="bg-greylight fw-600 text-grey-500 font-xssss ls-3 text-center">
                                                        {t('event.members.more')}
                                                    </a>
                                                </li>
                                            </ul>
                                            <a href="/defaultevent" className="font-xsssss fw-700 ps-3 pe-3 lh-32 float-right mt-4 text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1">
