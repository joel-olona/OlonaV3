                                        ...
                                        <div key={index} className="col-lg-6 col-md-6 col-sm-6 mb-3 pe-2 ps-2">
                                            <div className="card w-100 p-0 hover-card shadow-xss border-0 rounded-3 overflow-hidden me-1">
                                                ...
                                                <div className="card-image w-100 mb-3">
                                                    <a href="/defaulthoteldetails" className="position-relative d-block" title={t('hotel.actions.viewDetails')}>
                                                        <img src={`assets/images/${value.imageUrl}`} alt="hotel" className="w-100" />
                                                    </a>
                                                </div>
                                                <div className="card-body pt-0">
                                                    <i className="feather-bookmark font-md text-grey-500 position-absolute right-0 me-3" title={t('hotel.actions.bookmark')}></i>
                                                    <h4 className="fw-700 font-xss mt-0 lh-28 mb-0">
                                                        <a href="default-hotel-details.html" className="text-dark text-grey-900">{value.title}</a>
                                                    </h4>
                                                    <h6 className="font-xsssss text-grey-500 fw-600 mt-0 mb-2">{value.location}</h6>
                                                    <div className="star d-block w-100 text-left mt-0">
                                                        <img src="assets/images/star.png" alt={t('hotel.rating.stars')} className="w15 me-1 float-left" />
                                                        <img src="assets/images/star.png" alt={t('hotel.rating.stars')} className="w15 me-1 float-left" />
                                                        <img src="assets/images/star.png" alt={t('hotel.rating.stars')} className="w15 me-1 float-left" />
                                                        <img src="assets/images/star.png" alt={t('hotel.rating.stars')} className="w15 me-1 float-left" />
                                                        <img src="assets/images/star-disable.png" alt={t('hotel.rating.stars')} className="w15 me-1 float-left me-2" />
                                                    </div>
                                                    <div className="mt-4 w-100"></div>
                                                    <h5 className="mt-3 d-inline-block font-xssss fw-600 text-grey-500 me-2">
                                                        <i className="btn-round-sm bg-greylight ti-ruler-pencil text-grey-500 me-1"></i> 200 {t('hotel.details.amenities.area')}
                                                    </h5>
                                                    <h5 className="mt-3 d-inline-block font-xssss fw-600 text-grey-500 me-2">
                                                        <i className="btn-round-sm bg-greylight ti-rss-alt text-grey-500 me-1"></i> {t('hotel.details.amenities.wifi')}
                                                    </h5>
                                                    <h5 className="mt-3 d-inline-block font-xssss fw-600 text-grey-500">
                                                        <i className="btn-round-sm bg-greylight ti-credit-card text-grey-500 me-1"></i> {t('hotel.details.amenities.card')}
                                                    </h5>
                                                    ...
                                                    <span className="font-lg fw-700 mt-0 pe-3 ls-2 lh-32 d-inline-block text-success float-left">
                                                        ...
                                                        <span className="font-xsssss text-grey-500">{t('hotel.details.price.perMonth')}</span>
                                                    </span>
                                                    <a href="/defaulthoteldetails" className="position-absolute bottom-15 mb-2 right-15">
